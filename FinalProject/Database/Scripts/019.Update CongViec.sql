...
GO
/*
The column [dbo].[CongViec].[KyNang] is being dropped, data loss could occur.

The column [dbo].[CongViec].[Link] is being dropped, data loss could occur.

The column [dbo].[CongViec].[NgoaiNgu] is being dropped, data loss could occur.

The column [dbo].[CongViec].[TinHoc] is being dropped, data loss could occur.
*/
GO
...
CREATE TABLE [dbo].[tmp_ms_xx_CongViec] (
    ...
    [YeuCauUngVien]  NVARCHAR (2000) NULL,
    [FromDate]       DATE            NULL,
    [ToDate]         DATE            NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_CongViec] ([Id], [Ten], [TenCongTy], [Nganh], [ViTriTuyenDung], [MucLuong], [DiaDiem], [TrinhDoHocVan], [GioiTinh], [LienHe], [MoTa], [QuyenLoi], [KinhNghiem], [FromDate], [ToDate], [TrangThai], [SoLuong], [IsDeleted], [CreatedTime], [UpdatedTime], [IdCongTy])
        SELECT   [Id],
                 [Ten],
                 [TenCongTy],
                 [Nganh],
