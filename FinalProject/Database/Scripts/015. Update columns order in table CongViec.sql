...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[CongViec])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_CongViec] ([Id], [Ten], [Nganh], [ViTriTuyenDung], [MucLuong], [DiaDiem], [TrinhDoHocVan], [GioiTinh], [LienHe], [MoTa], [QuyenLoi], [NgoaiNgu], [TinHoc], [KinhNghiem], [KyNang], [FromDate], [ToDate], [TrangThai], [SoLuong], [Link], [IsDeleted], [CreatedTime], [UpdatedTime], [IdCongTy], [TenCongTy])
        SELECT   [Id],
                 [Ten],
                 [Nganh],
                 [ViTriTuyenDung],
